...
**Important**: The script will check for the manual NASS download (Step 1) and prompt you if it's missing. If you have additional questions follow the instructions in `documentation/USDA_NASS_Data_Acquisition.md` to download this file before running.
